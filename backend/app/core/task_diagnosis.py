...
CATEGORIES: list[CategoryDef] = [
    ...
    },
    {
        ...
        "summary": "apt/dpkg 正被其他进程占用，任务无法继续执行。",
        "possible_causes": [
            "apt-daily 或 apt-daily-upgrade 正在执行自动更新",
            "另一项软件安装、升级或系统维护任务正在运行",
            "前一次 apt/dpkg 操作尚未完成",
        ],
        "suggestions": [
            "等待占用 apt/dpkg 的进程结束后重新执行任务",
            "使用 ps -fp <PID> 或 systemctl status apt-daily.service apt-daily-upgrade.service 确认占用来源",
            "确认没有其他软件安装或系统升级任务并发运行",
        ],
        "risk_tips": [
            "不要手工删除 /var/lib/dpkg/lock* 或 /var/lib/apt/lists/lock；这可能损坏 dpkg 数据库。",
        ],
        "patterns": [
