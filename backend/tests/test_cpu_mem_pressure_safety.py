...
class CpuMemoryPressureSafetyTests(unittest.TestCase):
    ...
    def test_pressure_must_reach_cpu_and_memory_targets(self) -> None:
        ...
        self.assertIn('SCRIPT_VERSION="2026.08.17.1"', source)
        ...
        self.assertIn("stress_active", source)
        self.assertIn("STRESS_PID_FILE", source)
        self.assertIn("NR>1 + warmup && $12 != \"\" && $17 == 1", source)
